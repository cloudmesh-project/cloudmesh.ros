...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mybot_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/storage/github/cloudmesh/cloudmesh.ros/rosProj2/rosbot08/install/${idir}'.  Ask the maintainer 'eunosm3 <eunosm3@todo.todo>' to fix it.")
    endif()
