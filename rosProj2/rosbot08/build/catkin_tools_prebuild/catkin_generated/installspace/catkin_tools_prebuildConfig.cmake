...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/storage/github/cloudmesh/cloudmesh.ros/rosProj2/rosbot08/install/${idir}'.  Ask the maintainer 'jbohren <jbo@jhu.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/storage/github/cloudmesh/cloudmesh.ros/rosProj2/rosbot08/install/lib;/home/eunosm3/rosProject/rosProj2/rosbot03/devel/lib;/opt/ros/kinetic/lib)
