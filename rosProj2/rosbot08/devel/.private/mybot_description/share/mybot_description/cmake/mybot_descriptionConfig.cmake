...
if("TRUE" STREQUAL "TRUE")
  set(mybot_description_SOURCE_PREFIX /media/storage/github/cloudmesh/cloudmesh.ros/rosProj2/rosbot08/src/mybot_description)
  set(mybot_description_DEVEL_PREFIX /media/storage/github/cloudmesh/cloudmesh.ros/rosProj2/rosbot08/devel/.private/mybot_description)
  ...
  set(mybot_description_INSTALL_PREFIX /media/storage/github/cloudmesh/cloudmesh.ros/rosProj2/rosbot08/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mybot_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/storage/github/cloudmesh/cloudmesh.ros/rosProj2/rosbot08/src/mybot_description/${idir}'.  Ask the maintainer 'eunosm3 <eunosm3@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/storage/github/cloudmesh/cloudmesh.ros/rosProj2/rosbot08/devel/.private/mybot_description/lib;/media/storage/github/cloudmesh/cloudmesh.ros/rosProj2/rosbot08/devel/lib;/home/eunosm3/rosProject/rosProj2/rosbot03/devel/lib;/opt/ros/kinetic/lib)
